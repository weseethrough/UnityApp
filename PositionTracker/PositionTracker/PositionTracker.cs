...
namespace PositionTracker
{
    public class PositionTracker : IPositionTracker, IPositionListener
    {
        ...
        private static float MAX_TOLERATED_POSITION_ERROR = 21;
        // 21 metres
        private static float EPE_SCALING = 0.5f;
        // if predicted positions lie within 0.5*EPE circle
        ...
        public void StartTracking ()
        {
            ...
            if (gpsPosition != null)
                gpsPosition.trackId = track.trackId;
        ...
        public class SensorPollTick
        {
            ...
            public void Run (Object stateInfo)
            {
                ...
                case State.SENSOR_ACC:
                    ...
                    if (positionTracker.IndoorMode && sensorSpeedCap > positionTracker.MaxIndoorSpeed)
                        sensorSpeedCap = positionTracker.MaxIndoorSpeed;
