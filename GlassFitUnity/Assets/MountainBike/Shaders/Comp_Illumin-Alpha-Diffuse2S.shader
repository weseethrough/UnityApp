Shader "EnoShaders/AutoIllu/Transparent/Standard/Diffuse2S" {
Properties {
...
"vs_4_0
eefiecedmaplkokcnkookflnkpgbbdpjcglgmmklabaaaaaaaaafaaaaadaaaaaa
...
void main ()
{
  ...
  tmpvar_10 = (c_5.xyz * _Emission);
  tmpvar_3 = tmpvar_10;
  mediump float tmpvar_11;
  tmpvar_11 = c_5.w;
  tmpvar_4 = tmpvar_11;
  lowp vec4 c_12;
  c_12.xyz = ((tmpvar_2 * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * 2.0));
  c_12.w = tmpvar_4;
  c_1.w = c_12.w;
...
// FLOW 1 static, 0 dynamic
"vs_4_0_level_9_1
eefiecedgnncngojajiffgefiidodjcecmkojcnnabaaaaaaemahaaaaaeaaaaaa
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
// FLOW 1 static, 0 dynamic
"vs_4_0_level_9_1
eefiecedjediahllkmkgbdaclkojpfbdidaagallabaaaaaakaamaaaaaeaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedgecdgjbjolhaalpdbdhdfadcjdocmnkoabaaaaaakiacaaaaadaaaaaa
...
aaaaaaaaaeaaaaaaegacbaaaaaaaaaaadgaaaaaficcabaaaaaaaaaaadkaabaaa
abaaaaaadoaaaaab"
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedobcmicbdjnjgalajmgbpiallpieoiipcabaaaaaapeadaaaaaeaaaaaa
daaaaaaahiabaaaadiadaaaamaadaaaaebgpgodjeaabaaaaeaabaaaaaaacpppp
peaaaaaaemaaaaaaadaaciaaaaaaemaaaaaaemaaabaaceaaaaaaemaaaaaaaaaa
...
aiaaaaadabaaciiaabaaoelaadaaoekaalaaaaadacaaciiaabaappiaaeaaaaka
...
aeaaaaaeabaachiaabaabliaabaaaaiaacaaoeiaaeaaaaaeaaaachiaaaaaoeia
acaaaakaabaaoeiaabaaaaacaaaicpiaaaaaoeiappppaaaafdeieefcliabaaaa
eaaaaaaagoaaaaaafjaaaaaeegiocaaaaaaaaaaaafaaaaaafjaaaaaeegiocaaa
...
jgahbaaaaaaaaaaaagaabaaaaaaaaaaaegacbaaaacaaaaaadcaaaaakhccabaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
egaobaaaabaaaaaaegiocaaaaaaaaaaaadaaaaaadiaaaaaihcaabaaaacaaaaaa
egacbaaaabaaaaaaagiacaaaaaaaaaaaaeaaaaaadcaaaaajhccabaaaaaaaaaaa
...
adaaaaaaabaaahacaaaaaakeacaaaaaaabaaaaaaabaaaaaa mul r1.xyz, r0.xyzz, c1.x
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedijpcfcckphabhggdjlcodijaaogehodgabaaaaaageadaaaaaeaaaaaa
daaaaaaaeaabaaaamaacaaaadaadaaaaebgpgodjaiabaaaaaiabaaaaaaacpppp
...
abaacpiaabaaoeiaaaaaoekaafaaaaadacaachiaabaaoeiaabaaaakaaeaaaaae
abaachiaabaaoeiaaaaaoeiaacaaoeiaabaaaaacaaaicpiaabaaoeiappppaaaa
fdeieefchiabaaaaeaaaaaaafoaaaaaafjaaaaaeegiocaaaaaaaaaaaafaaaaaa
...
adaaaaaadiaaaaaihcaabaaaacaaaaaaegacbaaaabaaaaaaagiacaaaaaaaaaaa
aeaaaaaadcaaaaajhccabaaaaaaaaaaaegacbaaaabaaaaaaegacbaaaaaaaaaaa
egacbaaaacaaaaaadgaaaaaficcabaaaaaaaaaaadkaabaaaabaaaaaadoaaaaab
...
void main ()
{
  ...
  lowp vec4 c_13;
  c_13.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_12)).w) * 2.0));
  c_13.w = tmpvar_4;
  c_1.xyz = c_13.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_3 * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * 2.0));
  c_11.w = tmpvar_4;
  c_1.xyz = c_11.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_15;
  c_15.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * atten_14) * 2.0));
  c_15.w = tmpvar_4;
  c_1.xyz = c_15.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_12 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_13;
  c_13.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_12)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_13.w = tmpvar_4;
  c_1.xyz = c_13.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_11.w = tmpvar_4;
  c_1.xyz = c_11.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
FallBack "EnoShaders/AutoIllu/Diffuse"
}
